...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'public/img/strawberry.png',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'public/img/watermelon.png',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'public/img/pineapple.png',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'public/img/grapes.png',
            'description' => 'ブドウの中でも人気の高い国産の「巨峰」を使用しています。高い糖度と適度な酸味が魅力で、鮮やかなパープルで見た目も可愛',
        ];
        DB::table('products')->insert($param);
